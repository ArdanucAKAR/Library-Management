...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <asp:MultiView ID="mvMember" runat="server">
        <asp:View ID="vMemberDefault" runat="server"></asp:View>
        ...
        <asp:View ID="vMemberAdd" runat="server"></asp:View>
        <asp:View ID="vMemberUpdate" runat="server"></asp:View>
        <asp:View ID="vMemberDelete" runat="server"></asp:View>
    </asp:MultiView>
</asp:Content>
